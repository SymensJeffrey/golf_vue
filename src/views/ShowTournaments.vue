      ...
      <div class="row flex-nowrap justify-content-center no-border">
        ...
        >
          ...
          <div class="row justify-content-center border border-dark">
            <div :class="{ zero: score.hole1 == 0 , birdie: score.hole1 < tournament.course.hole1_par, bogey: score.hole1 > tournament.course.hole1_par}">{{ score.hole1 }}</div>
          </div>
          <div class="row justify-content-center border border-dark">
            <div :class="{ zero: score.hole2 == 0 , birdie: score.hole2 < tournament.course.hole2_par, bogey: score.hole2 > tournament.course.hole2_par}">{{ score.hole2 }}</div>
          </div>
          <div class="row justify-content-center border border-dark">
            <div :class="{ zero: score.hole3 == 0 , birdie: score.hole3 < tournament.course.hole3_par, bogey: score.hole3 > tournament.course.hole3_par}">{{ score.hole3 }}</div>
          </div>
          <div class="row justify-content-center border border-dark">
            <div :class="{ zero: score.hole4 == 0 , birdie: score.hole4 < tournament.course.hole4_par, bogey: score.hole4 > tournament.course.hole4_par}">{{ score.hole4 }}</div>
          </div>
          <div class="row justify-content-center border border-dark">
            <div :class="{ zero: score.hole5 == 0 , birdie: score.hole5 < tournament.course.hole5_par, bogey: score.hole5 > tournament.course.hole5_par}">{{ score.hole5 }}</div>
          </div>
          <div class="row justify-content-center border border-dark">
            <div :class="{ zero: score.hole6 == 0 , birdie: score.hole6 < tournament.course.hole6_par, bogey: score.hole6 > tournament.course.hole6_par}">{{ score.hole6 }}</div>
          </div>
          <div class="row justify-content-center border border-dark">
            <div :class="{ zero: score.hole7 == 0 , birdie: score.hole7 < tournament.course.hole7_par, bogey: score.hole7 > tournament.course.hole7_par}">{{ score.hole7 }}</div>
          </div>
          <div class="row justify-content-center border border-dark">
            <div :class="{ zero: score.hole8 == 0 , birdie: score.hole8 < tournament.course.hole8_par, bogey: score.hole8 > tournament.course.hole8_par}">{{ score.hole8 }}</div>
          </div>
          <div class="row justify-content-center border border-dark">
            <div :class="{ zero: score.hole9 == 0 , birdie: score.hole9 < tournament.course.hole9_par, bogey: score.hole9 > tournament.course.hole9_par}">{{ score.hole9 }}</div>
          </div>
          <div
            class="row justify-content-center border border-dark row-fill-green bold-text"
          >
          ...
          <div class="row justify-content-center border border-dark">
            <div :class="{ zero: score.hole10 == 0, birdie: score.hole10 < tournament.course.hole10_par, bogey: score.hole10 > tournament.course.hole10_par }">{{ score.hole10 }}</div>
          </div>
          <div class="row justify-content-center border border-dark">
            <div :class="{ zero: score.hole11 == 0, birdie: score.hole11 < tournament.course.hole11_par, bogey: score.hole11 > tournament.course.hole11_par }">{{ score.hole11 }}</div>
          </div>
          <div class="row justify-content-center border border-dark">
            <div :class="{ zero: score.hole12 == 0, birdie: score.hole12 < tournament.course.hole12_par, bogey: score.hole12 > tournament.course.hole12_par }">{{ score.hole12 }}</div>
          </div>
          <div class="row justify-content-center border border-dark">
            <div :class="{ zero: score.hole13 == 0, birdie: score.hole13 < tournament.course.hole13_par, bogey: score.hole13 > tournament.course.hole13_par }">{{ score.hole13 }}</div>
          </div>
          <div class="row justify-content-center border border-dark">
            <div :class="{ zero: score.hole14 == 0, birdie: score.hole14 < tournament.course.hole14_par, bogey: score.hole14 > tournament.course.hole14_par }">{{ score.hole14 }}</div>
          </div>
          <div class="row justify-content-center border border-dark">
            <div :class="{ zero: score.hole15 == 0, birdie: score.hole15 < tournament.course.hole15_par, bogey: score.hole15 > tournament.course.hole15_par }">{{ score.hole15 }}</div>
          </div>
          <div class="row justify-content-center border border-dark">
            <div :class="{ zero: score.hole16 == 0, birdie: score.hole16 < tournament.course.hole16_par, bogey: score.hole16 > tournament.course.hole16_par }">{{ score.hole16 }}</div>
          </div>
          <div class="row justify-content-center border border-dark">
            <div :class="{ zero: score.hole17 == 0, birdie: score.hole17 < tournament.course.hole17_par, bogey: score.hole17 > tournament.course.hole17_par }">{{ score.hole17 }}</div>
          </div>
          <div class="row justify-content-center border border-dark">
            <div :class="{ zero: score.hole18 == 0, birdie: score.hole18 < tournament.course.hole18_par, bogey: score.hole18 > tournament.course.hole18_par }">{{ score.hole18 }}</div>
          </div>
          <div
            class="row justify-content-center border border-dark row-fill-green bold-text"
          >
